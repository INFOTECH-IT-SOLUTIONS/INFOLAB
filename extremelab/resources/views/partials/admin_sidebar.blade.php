        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="{{route('admin.accounting.doctor_report')}}" class="nav-link" id="accounting_doctor_reports">
              <i class="far fa-circle nav-icon"></i>
              <p>
                {{__('ডাক্তারদের একাউন্টিং রিপোর্ট')}}
              </p>
            </a>
          </li>
          @endcan
      ...
      @canany(['view_user','view_role'])
        <li class="nav-item has-treeview" id="users_roles">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{route('admin.profile.edit')}}" class="nav-link" id="roles">
                <i class="fa fa-key nav-icon"></i>
                <p>{{__('পাসওয়ার্ড পরিবর্তন করুন')}}</p>
              </a>
            </li>
